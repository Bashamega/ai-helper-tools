        ...
        <div className="flex h-screen">
            <div className="hidden lg:flex items-center justify-center flex-1 bg-white text-black">
                <div className="max-w-md text-center">
                    <Image src={"login.svg"} width={500} height={500}></Image>
                </div>
            </div>
                ...
                <div className="max-w-md w-full p-6">
                    ...
                    <div className="mt-4 flex  flex-col items-center justify-between">
                        ...
                        <div className="w-full  ml-0 ">
                            <button onClick={()=>{signIn('github')}} type="button" className="w-full flex justify-center items-center gap-2 bg-white text-sm text-gray-600 p-2 rounded-md hover:bg-gray-50 border border-gray-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-colors duration-300">
                    ...
                    <div className="mt-4 text-sm text-gray-600 text-center">
                        <p>Don't have an account? <a href="/register" className="text-black hover:underline">Create an account</a>
                        </p>
                    </div>
                </div>
            </div>
